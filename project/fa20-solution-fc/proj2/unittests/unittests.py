...
class TestReadMatrix(TestCase):
    ...
    def test_exceptions(self):
        ...
        for err in error_dict:
            self.do_read_matrix(fail=err, code=error_dict[err])    
...
class TestWriteMatrix(TestCase):
    ...
    def test_exceptions(self):
        ...
        for err in error_dict:
            self.do_write_matrix(fail=err, code=error_dict[err])  
...
class TestMain(TestCase):
    ...
    def run_main(self, inputs, input_name, output_id, label):
        args = [f"{inputs}/m0.bin", f"{inputs}/m1.bin", f"{inputs}/inputs/{input_name}.bin",
    ...
    def test0(self):
        self.run_main("inputs/simple0/bin", "input0", "0", "2")

    def test1(self):
        self.run_main("inputs/simple1/bin", "input0", "1", "1")

    def test_mnist(self):
        self.run_main("inputs/mnist/bin", "mnist_input0", "m0", "6")
